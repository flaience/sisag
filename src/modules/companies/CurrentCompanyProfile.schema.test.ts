...
describe("current company profile input", () => {
  it("normalizes optional operational fields", () => {
    expect(CurrentCompanyProfileInputSchema.parse({ name: " Clínica Centro ", email: "", phone: "" })).toMatchObject({ name: "Clínica Centro", email: null, phone: null, tradeName: null, businessType: "generic" });
  });
