...
export function buildSidebarVisibility(
  ...
  return [
    ...
    { key: "services", label: text.services, href: "/admin/services", visible: canShowProfessionalsMenu(role), group: "structure" },
