...
type Proposal = { id: string; releasePlanId: string; releaseCandidateId: string; scope: string; status: "proposed" | "approved" | "rejected"; rolloutPercent: number; healthPolicyVersion: string; graduationPolicyVersion: string; evidence: { decision?: string; reasons?: string[]; observedDays?: number; observedFrom?: string; observedTo?: string }; reason: string; createdAt: string; version: number; reviewedBy: string | null; reviewedAt: string | null; reviewReason: string | null; reviewedVersion: number | null };
