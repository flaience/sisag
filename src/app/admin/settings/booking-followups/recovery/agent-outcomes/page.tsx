...
type Data = {
  ...
  retrieval: { executions:number; vectorRuns:number; fallbackRuns:number; averageOverlapRate:number; totalTokens:number; averageDurationMs:number; errors:Array<{errorCode:string;count:number}> };
