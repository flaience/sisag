  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 xl:grid-cols-3">
        <Card className="rounded-2xl">
          <CardHeader>
            <CardTitle>Pré-atendimento</CardTitle>
          </CardHeader>
          <CardContent className="space-y-3 text-sm text-slate-600">
            <p>{summary.pre}</p>
            <p>
              Esta área pode mostrar previsão do serviço, preparo do cliente,
              checklist e orientações antecipadas.
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="rounded-2xl">
          <CardHeader>
            <CardTitle>Pós-atendimento</CardTitle>
          </CardHeader>
          <CardContent className="space-y-3 text-sm text-slate-600">
            <p>{summary.post}</p>
            <p>
              Aqui entram follow-up, pesquisa de satisfação, valorização do
              cliente e reativação futura.
            </p>
          </CardContent>
        </Card>
      </div>
